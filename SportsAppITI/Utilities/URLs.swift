...
//    static let allEvents = main + "eventsseason.php?id=4329&s=2021-2022"
    static let allEvents = main + "eventsseason.php?id="
    //
//    static let allTeams = "https:www.thesportsdb.com/api/v1/json/2/search_all_teams.php?l=V8%20Supercars"
    static let allTeams = "https:www.thesportsdb.com/api/v1/json/2/search_all_teams.php?l="
